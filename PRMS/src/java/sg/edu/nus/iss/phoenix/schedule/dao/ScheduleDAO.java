...
public interface ScheduleDAO {
     ...
     */
    public abstract ProgramSlot getObject(int id)
    ...
    /**
     * Mia :yet to write doc
     *
     *
     * @param valueObject This parameter contains the class instance where
     * overlap checking will be based. Primary-key field should not be set.
     * @return
     * @throws java.sql.SQLException
     */
